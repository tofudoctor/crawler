...
def crawler(n):
    ...
    #data.encoding = "UTF-8"
    # 爬取前五筆餐廳卡片資料
    cards = root.find_all("div", class_="jsx-1475985536 restaurant-info", limit=5)
    content = ""
    ...
    for card in cards:
        name = card.find("a", class_="jsx-1475985536 title-text").text # 餐廳名稱
        rate = card.find("div", class_="jsx-1207467136 text") # 餐廳評價
        address = card.find("div", class_="jsx-1475985536 address-row").text  # 餐廳地址
